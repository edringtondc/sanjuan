...
const ScheduleNow = () => {
  ...
  return (
    <div className={classes.scheduleBlock}>
      ...
      <h1>The Wellness Center at San Juan Chiropractic</h1>
        ...
        <p>Chocolate bar jelly jelly-o cookie chocolate marshmallow jelly-o. Bear claw liquorice carrot cake pastry jelly beans gummi bears lollipop tootsie roll jelly. Sweet caramels topping apple pie.</p>
