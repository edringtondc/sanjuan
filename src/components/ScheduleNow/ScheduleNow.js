  ...
  return (
    <div className={classes.scheduleBlock}>
      ...
      <h1 className={classes.title}>The Wellness Center at San Juan Chiropractic</h1>
        ...
        <Button className={classes.scheduleButton} text={"Schedule Now"} link={"https://clients.mindbodyonline.com/ASP/adm/adm_appt_search.asp?studioid=591688&tg=&view=&sSU=&qParam=&lvl=&catid=&prodid=&date=5%2F10%2F2019&classid=0&loc=1&trn=0&stype=-9&vt=&justloggedin=&pMode=0&page=&prodGroupId=&optForwardingLink=&nLgIn="} />
      </div>
